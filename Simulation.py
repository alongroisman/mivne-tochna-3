...
class Simulation:
    ...
    """def actionMsg1(data, event):
        webbrowser.open("LogFile.txt")"""

    def actionButton1(data, event):
        data.action(BUTTON_NUMBER_1())

    def actionButton2(data, event):
        data.action(BUTTON_NUMBER_2())

    def actionButton3(data, event):
        data.action(BUTTON_NUMBER_3())
